...
// By using static router, this will show something is wrong with pets, which is covered correctly by its own tests. Import createRenderer and do a shallow render instead, as shown below this test.
